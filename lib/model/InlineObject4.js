    ...
    value: function constructFromObject(data, obj) {
      if (data) {
        ...
        if (data.hasOwnProperty('JobParameters')) {
          obj['JobParameters'] = _ApiClient["default"].convertToType(data['JobParameters'], {
            'String': 'String'
          });
        }
...
InlineObject4.prototype['JobParameters'] = undefined;
/**
 * @member {Array.<String>} Paths
 */

InlineObject4.prototype['Paths'] = undefined;
/**
 * @member {String} TaskID
 */

InlineObject4.prototype['TaskID'] = undefined;
