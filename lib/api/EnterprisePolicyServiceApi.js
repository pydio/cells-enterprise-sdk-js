...
var EnterprisePolicyServiceApi = /*#__PURE__*/function () {
  ...
  */
  ...
  _createClass(EnterprisePolicyServiceApi, [{
    ...
    value: function deletePolicyWithHttpInfo(uuid, opts) {
      opts = opts || {};
      ...
      return this.apiClient.callApi('/policy/{Uuid}', 'DELETE', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * [Enterprise Only] Delete a security policy
     * @param {String} uuid 
    ...
    key: "deletePolicy",
    value: function deletePolicy(uuid, opts) {
      return this.deletePolicyWithHttpInfo(uuid, opts).then(function (response_and_data) {
    ...
    value: function listBansWithHttpInfo() {
      ...
      return this.apiClient.callApi('/policy/ipbans', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * [Enterprise Only] List banned IPs
    ...
    value: function listIPsWithHttpInfo(name) {
      ...
      return this.apiClient.callApi('/policy/iplists/{Name}', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * [Enterprise Only] List white/black lists
     * @param {String} name 
    ...
    value: function putPolicyWithHttpInfo(body) {
      ...
      return this.apiClient.callApi('/policy', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * [Enterprise Only] Update or create a security policy
     * @param {module:model/IdmPolicyGroup} body 
    ...
    value: function unbanWithHttpInfo(body) {
      ...
      return this.apiClient.callApi('/policy/ipbans', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * [Enterprise Only] List banned IPs
     * @param {module:model/IpbanUnbanRequest} body 
    ...
    value: function updateIPsWithHttpInfo(body) {
      ...
      var accepts = ['application/json'];
      var returnType = _IpbanIPsCollection["default"];
      return this.apiClient.callApi('/policy/iplists', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * [Enterprise Only] Update white/black lists
     * @param {module:model/IpbanIPsCollection} body 
