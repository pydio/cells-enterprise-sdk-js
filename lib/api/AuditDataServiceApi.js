  ...
  */
  ...
  _createClass(AuditDataServiceApi, [{
    ...
    value: function listReportsWithHttpInfo() {
      ...
      var returnType = _ReportsListReportsResponse["default"];
      return this.apiClient.callApi('/audit/data/reports', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * [Enterprise Only] Audit all shares across the application
    ...
    value: function listReports() {
      return this.listReportsWithHttpInfo().then(function (response_and_data) {
    ...
    value: function sharedResourcesWithHttpInfo(body) {
      ...
      return this.apiClient.callApi('/audit/data/shares', 'POST', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * [Enterprise Only] Audit all shares across the application
     * @param {module:model/ReportsSharedResourcesRequest} body 
