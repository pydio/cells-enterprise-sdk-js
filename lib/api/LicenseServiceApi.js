  ...
  */
  ...
  _createClass(LicenseServiceApi, [{
    ...
    value: function licenseStatsWithHttpInfo(opts) {
      ...
      return this.apiClient.callApi('/license/stats', 'GET', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * [Enterprise Only] Display statistics about licenses usage
     * @param {Object} opts Optional parameters
    ...
    value: function putLicenseInfoWithHttpInfo(body) {
      ...
      return this.apiClient.callApi('/license/update', 'PUT', pathParams, queryParams, headerParams, formParams, postBody, authNames, contentTypes, accepts, returnType, null);
    }
    /**
     * [Enterprise Only] Update License String
     * @param {module:model/CertPutLicenseInfoRequest} body 
